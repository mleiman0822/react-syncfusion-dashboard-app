            ...
            {earningData.map((item) => (
                ...
                p-4 pt-9 rounded-2xl'>
                  ...
                  <p className='mt-3'>
                    ...
                    {/* There is a tailwindcss bug here that wont register string interpolation
                    the first time. Change to static then change back and it works. */}
              ...
              <div className='border-r-1 border-color m-4 pr-10'>
                    <div>
                      <p>
                        ...
                        <span className='p-1.5 hover:drop-shadow-lg cursor-pointer rounded-full
