...
export const EditorData = () => (
  <div>
    <h3>
        Hi there, feel free to make some changes and edit anything you'd like. There is 
        a lot of stuff you can do with this editor, but no backend, so this will merely
        reset once you refresh the page.
    </h3>
  </div>
);
